...
const MainLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Mobile Header */}
      <div className="lg:hidden bg-white shadow-md fixed top-0 left-0 right-0 z-40">
        <div className="flex items-center justify-between p-4">
          ...
          <h1 className="text-lg font-semibold text-emerald-600">Mango Business</h1>
        ...
        <div className="p-4 border-b">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">{user?.email || 'admin@mango.com'}</p>
            </div>
          </div>
        </div>
